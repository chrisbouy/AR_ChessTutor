...
var Engine = function(boardSize, lightSquare, darkSquare, selectColor) {
  ...
  function makeMove(move) {
      // console.log('making wukong move');
    // update plies
    searchPly++;
    gamePly++;
  ...
  */
  ...
  return {
    ...
    search: function(depth,fen) { return searchPosition(depth,fen) },
    searchTime: function(ms) {
      //console.log('wukong searchtime start');
      resetTimeControl();
      let startTime = new Date().getTime();
      timing.timeSet = 1;
      timing.time = ms;
      timing.stopTime = startTime + timing.time;
      const result = this.search(64);
      //console.log('wukong searchtime end');
      return result; 
    },
